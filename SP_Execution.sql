...
EXEC SP_CreateExamWithRandomQuestions
     @Date       = '2025-09-15',
     @Start_time = '2025-09-15 10:00',
     @End_time   = '2025-09-15 12:00',
     @Corrective = 0,
     @Bran_ID    = 1,   -- one branch
     @Crs_ID     = 3,   -- one course
     @Intake_ID  = 1,
     @Ins_ID     = 2,
     @Track_ID   = 1,   -- one track
     @NumMCQ     = 12,  -- will auto-rebalance if pool has fewer MCQs
     @NumTF      = 8;
